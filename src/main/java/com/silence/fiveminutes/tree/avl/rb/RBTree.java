...
public class RBTree<T extends Comparable<T>> {
     ...
     *      知道遇到当前处理节点的父亲是黑色或者到根节点。如果祖父节点就是root节点，那么操作后会把根节点变为红色。
     ...
     *          祖父节点的颜色肯定是黑色。此时我们将兄弟节点变成黑色，兄弟节点左孩子变为红色，然后对祖父节点进行左旋。
     *          这样就能保证删除并旋转后左边的黑高不变，右边的黑高也不变。变化的是兄弟右红变成黑色，而左边则由删除后没有黑节点变成
